...
function initIMG08Swiper() {
  ...
  Array.prototype.forEach.call(targetSwipers, function(el, i){
    ...
    slides.length === 3 && targetSlide.classList.add('col3');
    slides.length === 2 && targetSlide.classList.add('col2');
    ...
    if(slides.length > 3) {
      ...
      $(".cmpnt-img08__swiper .cmpnt-img08__item").chunk(groupNum).wrap('<div class="swiper-slide"></div>');      
